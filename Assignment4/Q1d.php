...
echo "RECEIVED: "; $handle4 = fopen ("php://stdin","r"); $RECEIVED = trim(fgets($handle4));
echo "SHIPPED: "; $handle5 = fopen ("php://stdin","r"); $SHIPPED = trim(fgets($handle5));

mysqli_query($conn,"INSERT INTO orders (ONO, CNO, ENO, RECEIVED, SHIPPED)
VALUES ('$ONO','$CNO', '$ENO', '$RECEIVED', '$SHIPPED')");
echo "\nOrder added: $ONO | $CNO | $ENO | $RECEIVED | $SHIPPED\n";
}
